...
{
    public partial class D2AdminServiceContextInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Intro = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    FirstLetter = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    parent_id = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Avatar = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CallingCode = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
